 ...
 */
public class MyCalendarListAdapter extends ArrayAdapter<EventTO> {
    private Context context;
    private List<EventTO> items;

    public MyCalendarListAdapter(Context ctx, List<EventTO> list){
        super(ctx, R.layout.my_calendar_item, list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            view = inflater.inflate(R.layout.my_calendar_item, null);
        } else{
            view = convertView;
        }
        ...
        TextView placeCategory = (TextView) view.findViewById(R.id.calendar_place_category);
        TextView dateTime = (TextView) view.findViewById(R.id.calendar_date_time);
